 ...
 * noma team
 -------------------------------------------------------------------*/
    ...
    input = document.getElementById('xhost-filter-input');
    filter = input.value.toUpperCase();
    ul = document.getElementById("xhost-filter-list");
	...
	jQuery('#xhost-filter-list li a').on('click', function() {
	$(this).addClass("filter-item-open");
	$('.xhost-filter-list-container').addClass("xhost-filter-min-height");
	$('#' + this.id + '-content').delay(200).fadeIn(300);
	});
	
	jQuery('.filter-content-close').on('click', function() {
	$(this).addClass("filter-item-open");
	$('.xhost-filter-list-container').removeClass("xhost-filter-min-height");
